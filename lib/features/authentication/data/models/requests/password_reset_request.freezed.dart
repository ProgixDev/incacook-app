...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PasswordResetRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.redirectTo, redirectTo) || other.redirectTo == redirectTo));
}
...
@override
String toString() {
  return 'PasswordResetRequest(email: $email, redirectTo: $redirectTo)';
}
...
class _PasswordResetRequest implements PasswordResetRequest {
  const _PasswordResetRequest({required this.email, this.redirectTo});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PasswordResetRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.redirectTo, redirectTo) || other.redirectTo == redirectTo));
}
